...
\begin{enumerate}
    \item $z^{4} - 2z^{2} + 4 =0$
    \vspace{2cm}
    \item $z^{4} - 4z^{3} + 7z^{2} - 4z + 6 = 0$ given $z = i$ is a solution 
    \vspace{3cm}
    \item $z^{3} - (2-i)z^{2} = 2-i-z$
    \vspace{3cm}
    \item $z^{3} + 2i z^{2} - 2z - i = 0$ given that $z = -i$ is a solution
    \vspace{3cm}
    \item $z^{2} = i \bar{z}$, give your answer(s) in cartesian form.
    \vspace{3cm}
    \item (By hand) $z^{4} -1 - \sqrt{3}i = 0$, give your answer(s) in cartesian form where possible
    \vspace{3cm}
    \item Find (in cartesian form) all quartic roots of $z = i$
    \vspace{3cm}
    \item if $|z| = 1$ and $Arg(z) = \theta $, show that $\frac{2}{1+z} = 1-i\tan(\theta /2)$
    \vspace{3cm}
    \item Factorise $z^{3} + i z^{2} + 2i$
    \vspace{3cm}
    \item write $\left(\frac{-\sqrt{3} + i}{2 - 2\sqrt{3}i}\right)^{3}$ in the form of $a + b i, a,b \in \mathbb{R}$
    \vspace{3cm}
    \item Find all solutions to $z^{4} = \sqrt{3}z^{2} -1 $ in polar form
\end{enumerate}
